...
const projects: Project[] = [
    {
        ...
        videoUrl:'https://www.youtube.com/watch?v=f9cceaOpcUg',
        category: 'fullstack',
    },
    {
        id: '2',
        ...
        description:
            'A machine learning model that generates artistic images from text descriptions using stable diffusion.',
    ...
    },
    {
        ...
        liveUrl: '',
        devpostUrl: 'https://devpost.com/YourOtherProjectHere', // Example DevPost link
        imageUrl: '/projects/portfolio.jpg',
        videoUrl:'https://www.youtube.com/embed/DhvwM8waTL0?si=VQNn-7eZgZOpdCTw',
        category: 'ml',
    },
