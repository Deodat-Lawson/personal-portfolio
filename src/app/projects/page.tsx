...
const projects: Project[] = [
    ...
    },
    {
        ...
        liveUrl: 'https://utfs.io/f/KSLubuOGoQY2s4vZKVdpmd4szvqeVgkJXNHKZUOc3CF051YR',
        devpostUrl: '',
        imageUrl: '',
    ...
    },
    {
        id: '8',
        title: 'Project Venus',
        description: 'A geographical real-estate service that allows users to buy and sell real-estates',
        technologies: ['Django', 'React.js', 'Geojango'],
    ...
    {
        id: '11',
        title: 'Time Converter App (Private Git Repo)',
        description: 'Our application converter application from one time to another',
        technologies: ['Android Studio'],
        githubUrl: 'https://github.com/Deodat-Lawson/TimeConverterApp',
        githubUrl2: '',
        liveUrl: 'https://utfs.io/f/KSLubuOGoQY26YOvLlXC7s4elZngmFYkXtoSbH9uraUIxfpG',
        devpostUrl: '',
        imageUrl: '',
        videoUrl:'https://youtube.com/embed/8-RBvg9mCpk?si=xgnRPNCS4DIuCgZH',
        category: 'mobile',
    },
